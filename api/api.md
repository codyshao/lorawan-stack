...
| `downlink_api_key` | [`string`](#string) |  | The API key to be used for downlink queue operations. |
...
| `create_downlink_key` | [`bool`](#bool) |  | Whetever to create a downlink queue operations API key. |
